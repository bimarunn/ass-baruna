import 'package:uas_aplikasi/View/Component/Category.dart';
import 'package:uas_aplikasi/View/Screens/Detail.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 232, 200, 19),
      appBar: AppBar(
